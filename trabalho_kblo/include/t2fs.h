...
#define NUM_FAT_PER_SECTOR 128
#define ERROR_SIGNAL -1
#define NUM_REC_PER_SECTOR 8

unsigned int NUM_REC_PER_CLUSTER;
unsigned int CLUSTER_SIZE;
unsigned int OFFSET_DATA;

struct t2fs_superbloco currentDisk;
char *currentDirectory;
struct t2fs_record *currentDirRecord;
...
int findFile(char *datapath, struct t2fs_record *recordRequired);
int findFileAndFather(char *datapath, struct t2fs_record *recordRequired,  int *sectorFather, int *recordPosition);
